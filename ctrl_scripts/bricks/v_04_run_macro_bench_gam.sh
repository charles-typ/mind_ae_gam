...
if [[ "$4" = "ma" ]]; then
	if [[ $1 -eq 0 ]]; then
	  echo $make_cmd $2 $3 $6 $7 $8 $9 1 1 $5 /test_program_log/${4}/${10}_0_0 /test_program_log/${4}/${10}_1_0 /test_program_log/${4}/${10}_2_0 /test_program_log/${4}/${10}_3_0 /test_program_log/${4}/${10}_4_0 /test_program_log/${4}/${10}_5_0 /test_program_log/${4}/${10}_6_0 /test_program_log/${4}/${10}_7_0 /test_program_log/${4}/${10}_8_0 /test_program_log/${4}/${10}_9_0 
	  $make_cmd $2 $3 $6 $7 $8 $9 1 1 $5 /test_program_log/${4}/${10}_0_0 /test_program_log/${4}/${10}_1_0 /test_program_log/${4}/${10}_2_0 /test_program_log/${4}/${10}_3_0 /test_program_log/${4}/${10}_4_0 /test_program_log/${4}/${10}_5_0 /test_program_log/${4}/${10}_6_0 /test_program_log/${4}/${10}_7_0 /test_program_log/${4}/${10}_8_0 /test_program_log/${4}/${10}_9_0 
	elif [[ $1 -eq 1 ]]; then
	  ...
	  $make_cmd $2 $3 $6 $7 $8 $9 0 1 $5 /test_program_log/${4}/${10}_60_0 /test_program_log/${4}/${10}_61_0 /test_program_log/${4}/${10}_62_0 /test_program_log/${4}/${10}_63_0 /test_program_log/${4}/${10}_64_0 /test_program_log/${4}/${10}_65_0 /test_program_log/${4}/${10}_66_0 /test_program_log/${4}/${10}_67_0 /test_program_log/${4}/${10}_68_0 /test_program_log/${4}/${10}_69_0 
	  ...
	  $make_cmd $2 $3 $6 $7 $8 $9 0 1 $5 /media/data_raid0/${10}_logs/${10}_70_0 /media/data_raid0/${10}_logs/${10}_71_0 /media/data_raid0/${10}_logs/${10}_72_0 /media/data_raid0/${10}_logs/${10}_73_0 /media/data_raid0/${10}_logs/${10}_74_0 /media/data_raid0/${10}_logs/${10}_75_0 /media/data_raid0/${10}_logs/${10}_76_0 /media/data_raid0/${10}_logs/${10}_77_0 /media/data_raid0/${10}_logs/${10}_78_0  /media/data_raid0/${10}_logs/${10}_79_0 
	...
	if [[ $1 -eq 0 ]]; then
	  ...
	  $make_cmd $2 $3 $6 $7 $8 $9 1 1 $5 /test_program_log/${4}/0 /test_program_log/${4}/1 /test_program_log/${4}/2 /test_program_log/${4}/3 /test_program_log/${4}/4 /test_program_log/${4}/5 /test_program_log/${4}/6 /test_program_log/${4}/7 /test_program_log/${4}/8 /test_program_log/${4}/9 
	elif [[ $1 -eq 1 ]]; then
	  ...
	  $make_cmd $2 $3 $6 $7 $8 $9 0 1 $5 /test_program_log/${4}/20 /test_program_log/${4}/21 /test_program_log/${4}/22 /test_program_log/${4}/23 /test_program_log/${4}/24 /test_program_log/${4}/25 /test_program_log/${4}/26 /test_program_log/${4}/27 /test_program_log/${4}/28 /test_program_log/${4}/29 
	  ...
	  $make_cmd $2 $3 $6 $7 $8 $9 0 1 $5 /test_program_log/${4}/40 /test_program_log/${4}/41 /test_program_log/${4}/42 /test_program_log/${4}/43 /test_program_log/${4}/44 /test_program_log/${4}/45 /test_program_log/${4}/46 /test_program_log/${4}/47 /test_program_log/${4}/48 /test_program_log/${4}/49 
	  ...
	  $make_cmd $2 $3 $6 $7 $8 $9 0 1 $5 /media/data_raid0/${10}_logs/50 /media/data_raid0/${10}_logs/51 /media/data_raid0/${10}_logs/52 /media/data_raid0/${10}_logs/53 /media/data_raid0/${10}_logs/54 /media/data_raid0/${10}_logs/55 /media/data_raid0/${10}_logs/56 /media/data_raid0/${10}_logs/57 /media/data_raid0/${10}_logs/58  /media/data_raid0/${10}_logs/59 
	  ...
	  $make_cmd $2 $3 $6 $7 $8 $9 0 1 $5 /test_program_log/${4}/60 /test_program_log/${4}/61 /test_program_log/${4}/62 /test_program_log/${4}/63 /test_program_log/${4}/64 /test_program_log/${4}/65 /test_program_log/${4}/66 /test_program_log/${4}/67 /test_program_log/${4}/68 /test_program_log/${4}/69 
	  ...
	  $make_cmd $2 $3 $6 $7 $8 $9 0 1 $5 /media/data_raid0/${10}_logs/70 /media/data_raid0/${10}_logs/71 /media/data_raid0/${10}_logs/72 /media/data_raid0/${10}_logs/73 /media/data_raid0/${10}_logs/74 /media/data_raid0/${10}_logs/75 /media/data_raid0/${10}_logs/76 /media/data_raid0/${10}_logs/77 /media/data_raid0/${10}_logs/78  /media/data_raid0/${10}_logs/79 
