...
set xtics 1 nomirror font "Helvetica, 20"
...
set output "./worse_case_write.eps"
...
plot "./ideal_thread0_write" using 1:2 title "1node write" w lp ls 1,\
    "./worse_single_thread0_write" using 1:2 title "4node write" w lp ls 2,\
    "./worse_thread0_write" using 1:2 title "4node write" w lp ls 3
