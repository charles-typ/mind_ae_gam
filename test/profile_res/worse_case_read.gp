...
set output "./worse_case_read.eps"
...
plot "./ideal_thread0_read" using 1:2 title "1node read" w lp ls 1,\
    "./worse_single_thread0_read" using 1:2 title "4node read" w lp ls 2,\
    "./worse_thread0_read" using 1:2 title "4node read" w lp ls 3
