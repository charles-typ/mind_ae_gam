...
set output "./1node_write_diff.eps"
...
plot "./1node_thread0_write" using 1:2 title "1node write" w lp ls 1,\
    "./2node_thread0_write" using 1:2 title "2node write" w lp ls 2,\
    "./3node_thread0_write" using 1:2 title "3node write" w lp ls 3,\
    "./4node_thread0_write" using 1:2 title "4node write" w lp ls 4
